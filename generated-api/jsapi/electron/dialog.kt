...
object dialog {
     ...
     * @returns 
     */
    fun showOpenDialog(browserWindow: BrowserWindow? = null, options: ShowOpenDialogOptions.() -> Unit, callback: ((filePaths: Array<String>) -> Unit)? = null): Array<String> = 
     ...
     * @returns 
     */
    fun showSaveDialog(browserWindow: BrowserWindow? = null, options: ShowSaveDialogOptions.() -> Unit, callback: ((filename: String) -> Unit)? = null): String = 
     ...
     * @returns 
     */
    fun showMessageBox(browserWindow: BrowserWindow? = null, options: ShowMessageBoxOptions, callback: ((response: Number, checkboxChecked: Boolean) -> Unit)? = null): Int = 
